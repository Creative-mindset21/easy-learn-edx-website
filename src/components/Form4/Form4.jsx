  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      try {
        ...
        const response = await fetch("https://edubackend-zs7x.onrender.com/v1/create-student", {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            special_education_needs_comments: formData.specialEducationNeedsComments || null,  // Optional
          }),
        });
